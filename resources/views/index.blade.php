...
<br>
	...
	<div class="contact-form">
		...
		<h2>USER LOGIN</h2>
			...
			<p>Userrname</p><input type="text" name="rusername" placeholder="username"class="form-control">
...
<br>
        ...
        <td><a href="/register"><button class="btn btn-primary" type="submit" >Create an Account </button></a></td>
        <td><a href="/adminlogin"><button class="btn btn-primary" type="submit" >Admin login </button></a></td>
    <td><a href="/register"><button class="btn btn-primary" type="submit" >Create an Account </button></a></td></center>
