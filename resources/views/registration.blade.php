...
<br>
<tr>
    <input type="text" name="rusername"  value="{{old('rusername')}}"  class="form-control" placeholder="UserName...">
    <span class="text-danger">@error('rusername'){{$message}} @enderror  </span>
